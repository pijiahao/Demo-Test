(function ($) {
    ...
    Uploadfile.prototype.initbody = function () {
        ...
        var self = this;
        var html = '<div class="form-group   inputfile"><label class="col-sm-' + this.default.collenght + ' control-label form-label label-attachment">{0}</label>' +
    ...
    Uploadfile.prototype.getimghtml = function (filename, fileurl) {
        ...
        if (ext == "doc" || ext == "docx") {
            strhtml += '<img src="/content/Common/my-plug-in/UploadFile/images/word.png" class="file-preview-image kv-preview-data" onclick="ImgMagnifying(this)" title= "' + filename + '" alt= "' + filename + '" style= "width:auto;height:40px;max-width:80px;" >';

        }
        else if (ext == "xls" || ext == "xlsx") {
            strhtml += '<img src="/content/Common/my-plug-in/UploadFile/images/excel.png" class="file-preview-image kv-preview-data" onclick="ImgMagnifying(this)" title= "' + filename + '" alt= "' + filename + '" style= "width:auto;height:40px;max-width:80px;" >';

        }
        else if (ext == "ppt" || ext == "pptx") {
            strhtml += '<img src="/content/Common/my-plug-in/UploadFile/images/ppt.png" class="file-preview-image kv-preview-data" onclick="ImgMagnifying(this)" title= "' + filename + '" alt= "' + filename + '" style= "width:auto;height:40px;max-width:80px;" >';
        }
        else if (ext == "pdf") {
            strhtml += '<img src="/content/Common/my-plug-in/UploadFile/images/pdf.png" class="file-preview-image kv-preview-data" onclick="ImgMagnifying(this)" title= "' + filename + '" alt= "' + filename + '" style= "width:auto;height:40px;max-width:80px;" >';
        }
        else {
            if (fileurl != "" && fileurl != null && fileurl != undefined) {
                ...
                strhtml += '<img src="/content/Common/my-plug-in/UploadFile/images/notfile.jpg" class="file-preview-image kv-preview-data" onclick="ImgMagnifying(this)" title= "' + filename + '" alt= "' + filename + '" style= "width:auto;height:40px;max-width:80px;" >';
            }
    ...
    var uploadfileallowedMethods = ["getformdata", "refresh", "getfiledata", "load", "delete", "addfilesinformdata", "disabled", "getremoveloaddataids"];
