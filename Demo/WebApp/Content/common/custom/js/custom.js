...
function init_sidebar() {
    ...
    var setContentHeight = function () {
        ...
        var bodyHeight = $BODY.outerHeight(),
            ...
            topHeight = $TOP_NAV.height() - 47;

        // normalize content
        contentHeight -= ($NAV_MENU.height() + footerHeight + topHeight);

        $RIGHT_COL.css('min-height', contentHeight);
        $PanelBody.css('height', contentHeight - 25);
...
function operateDateFormatter(value, row, index) {
    ...
    return new Date(value).Format("yyyy-MM-dd hh:ss");
}
